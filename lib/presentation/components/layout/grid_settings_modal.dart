...
class _GridSettingsModalState extends State<GridSettingsModal> {
  ...
  void initState() {
    ...
    _incrementCtrl = TextEditingController(text: store.snapIncrement.toString());
  }
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      title: const Text('Grid Snapping Settings', style: TextStyle(color: Colors.white)),
      content: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          SwitchListTile(
            title: const Text('Enable Magnet', style: TextStyle(color: Colors.white70)),
            value: _enabled,
          ...
          ListTile(
            ...
            title: const Text('Increment Value', style: TextStyle(color: Colors.white70)),
            trailing: SizedBox(
              width: 80,
              child: TextField(
          ...
          RadioListTile<bool>(
            title: const Text('Global Grid', style: TextStyle(color: Colors.white70)),
            subtitle: const Text('Snap to world coordinates (0, 1, 2...)', style: TextStyle(color: Colors.white30, fontSize: 11)),
            value: true,
          ...
          RadioListTile<bool>(
            title: const Text('Current Position', style: TextStyle(color: Colors.white70)),
            subtitle: const Text('Snap relative to current position', style: TextStyle(color: Colors.white30, fontSize: 11)),
            value: false,
            groupValue: _snapToGrid,
            activeColor: Colors.blueAccent,
            onChanged: (v) => setState(() => _snapToGrid = v!),
